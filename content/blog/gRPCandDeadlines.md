...
> 原文：[https://grpc.io/blog/deadlines/](https://grpc.io/blog/deadlines/)
>
> 收录该文档的时间：`2024-11-19T11:35:00+08:00`

# gRPC and Deadlines

By **Gráinne Sheerin** (Google SRE) | Monday, February 26, 2018
...
As a client you should always set a deadline for how long you are willing to wait for a reply from the server. Here are examples using the Greeting service from the [Quick start](https://grpc.io/docs/quickstart/) pages:
