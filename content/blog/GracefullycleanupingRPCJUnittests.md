...
> 原文：[https://grpc.io/blog/graceful-cleanup-junit-tests/](https://grpc.io/blog/graceful-cleanup-junit-tests/)
>
> 收录该文档的时间：`2024-11-19T11:35:00+08:00`

# Gracefully clean up in gRPC JUnit tests

By [**Dapeng Zhang**](https://github.com/dapengzhang0) (Google) | Tuesday, June 26, 2018
...
Now with [`GrpcCleanupRule`](https://github.com/grpc/grpc-java/blob/v1.13.x/testing/src/main/java/io/grpc/testing/GrpcCleanupRule.java) you don’t need to worry about graceful shutdown of gRPC servers and channels in JUnit test. So try it out and clean up in your tests!
