...
The example code is part of the `grpc` repo under [examples/cpp/route_guide](https://github.com/grpc/grpc/tree/v1.66.0/examples/cpp/route_guide). Get the example code and build gRPC:
...
For simplicity, we’ve provided a [CMakeLists.txt](https://github.com/grpc/grpc/blob/v1.66.0/examples/cpp/route_guide/CMakeLists.txt) that runs `protoc` for you with the appropriate plugin, input, and output (if you want to run this yourself, make sure you’ve installed protoc and followed the gRPC code [installation instructions](https://github.com/grpc/grpc/blob/v1.66.0/src/cpp/README.md#cmake) first):
...
You can find our example `RouteGuide` server in [examples/cpp/route_guide/route_guide_server.cc](https://github.com/grpc/grpc/blob/v1.66.0/examples/cpp/route_guide/route_guide_server.cc). Let’s take a closer look at how it works.
...
In this section, we’ll look at creating a C++ client for our `RouteGuide` service. You can see our complete example client code in [examples/cpp/route_guide/route_guide_client.cc](https://github.com/grpc/grpc/blob/v1.66.0/examples/cpp/route_guide/route_guide_client.cc).
