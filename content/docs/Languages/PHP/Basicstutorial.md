...
The example code for our tutorial is in [grpc/grpc/examples/php/route_guide](https://github.com/grpc/grpc/tree/v1.66.0/examples/php/route_guide). To download the example, clone the `grpc` repository and its submodules by running the following command:
...
In this section, we’ll look at creating a PHP client for our `RouteGuide` service. You can see our complete example client code in [examples/php/route_guide/route_guide_client.php](https://github.com/grpc/grpc/blob/v1.66.0/examples/php/route_guide/route_guide_client.php).
