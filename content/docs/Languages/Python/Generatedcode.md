...
- [**Stub**](https://grpc.io/docs/languages/python/generated-code/#stub): `FooStub` used by the client to connect to a gRPC service.
- [**Servicer**](https://grpc.io/docs/languages/python/generated-code/#servicer): `FooServicer` used by the server to implement a gRPC service.
- [**Registration Function**](https://grpc.io/docs/languages/python/generated-code/#registration-function): `add_FooServicer_to_server` function used to register a servicer with a `grpc.Server` object.
