...
- Work through the [Basics tutorial]({{< ref "/docs/Languages/Python/Basicstutorial" >}}).
- Explore the [API reference]({{< ref "/docs/Languages/Python/API" >}}).
