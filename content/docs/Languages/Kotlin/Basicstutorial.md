...
First consider how to create a `RouteGuide` server. If you’re only interested in creating gRPC clients, skip ahead to [Creating the client](https://grpc.io/docs/languages/kotlin/basics/#client) – though you might find this section interesting anyway!
